...
class ZonalStatistics():
    ...
    def __init__(self, source_vector, raster_path, destination, band_number=1, column_prefix='', use_global_extent=False, operations=('mean',), fields_alias=None):
        ...
        if not self.raster_ds:
            raise RuntimeError('Raster "{}" not found.'.format(raster_path))
...
if __name__ == '__main__':
    ...
    r"""
    C:\Program Files\QGIS 2.18\apps\qgis\python\plugins\processing\algs\qgis\ZonalStatistics.py
    """
    ...
    destination_source = r'D:\Projetos\0023.2016_TAESA\data\iginicao\tmp\para_preencher\novo_tmp.shp'
